...
$mail->SMTPDebug = 2;
    ...
    $mail->AddAddress("alugox@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->IsSMTP(); 
    $mail->Host = gethostbyname("smtp.gmail.com");  // Servidor de Salida. 465 es uno de los puertos que usa Google para su servidor SMTP
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;
    $mail->SMTPAuth = true; 
    $mail->Username = "alugox@gmail.com";  // Correo Electrónico
    $mail->Password = "arm-7572747"; // Contraseña del correo
