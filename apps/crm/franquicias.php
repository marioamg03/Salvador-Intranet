...
/*DEPENDIENDO DE LAS SELECCION CAMBIA LAS PREGUNTAS DEL PRIMER FORMULARIO OJO.*/
...
function cargarCuestFranq2($id){
	...
	// var_dump($all);
	if ($all[0] == "0" || $all[0]["respuestas2"] == "" ) {
				// var_dump($all);

				$result = '<div class="alert alert-danger" role="alert">
				NO A RESPONDIDO LA ENCUESTA..!!!
			</div>
			
			<a href="http://salvadorhairdressing.com/forms/enviar.php?id='.$id.'"><button type="button" class="btn btn-warning">Enviar Encuenta</button></a>
			';
		...
		<div class="col-sm-12">
			...
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						...
						<div>'.$all['pregunta1'].'.</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Conoce el término de franquicia?</b></div>
						<div>'.$all['pregunta2'].'.</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Qué haría usted para impulsar los primeros 6 meses de desarrollo del negocio?</b></div>
						<div>'.$all['pregunta3'].'.</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Con qué frecuencia quiere manejar su negocio?</b></div>
						<div>'.$all['pregunta4'].'</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Considera que tiene un buen manejo de personal?</b></div>
						<div>'.$all['pregunta5'].'.</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Maneja directamente sus operaciones financieras?</b></div>
						<div>'.changeNum($all['pregunta6']).'</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Tiene experiencia con crédito bancario?</b></div>
						<div>'.changeNum($all['pregunta7']).'</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Es usted dinámico al gestionar solicitudes, proveedores y solución de conflictos?</b></div>
						<div>'.changeNum($all['pregunta8']).'</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Cuáles son sus aspiraciones de crecimiento con Salvador Hairdressing en los próximos 5, 10 y 15 años?</b></div>
						<div>'.$all['pregunta9'].'.</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Es usted bueno en el área de ventas?</b></div>
						<div>'.changeNum($all['pregunta10']).'.</div>
					</div>
			</div>
			<div class="form-group row list-group-item sel">
					<div class="col-sm-12">
						<div><b>¿Fuente de ingresos actual?</b></div>
						<div>'.changeNum($all['pregunta11']).'. <br> '.$all['pregunta12'].'</br></div>
					</div>
			</div>
			<div class="col-sm-12 pt-10">
				<div class="text-center">
